...
public class Order : Aggregate<Guid>
{
    ...
    public virtual IReadOnlyList<OrderItem> Items => _items.AsReadOnly();

    public Guid CustomerId { get; private set; } = default!;
    public string OrderName { get; private set; } = default!;
    public virtual Address ShippingAddress { get; private set; } = default!;
    public virtual Address BillingAddress { get; private set; } = default!;
    public virtual Payment Payment { get; private set; } = default!;
